...
impl<A: AIR> ConstraintEvaluator<A> {
        ...
        A: Send + Sync,
    {
        ...
        // println!("{}", domain.lde_roots_of_unity_coset.len());
        ...
        let evaluations_t = evaluations_t_iter
            ...
            .map(|i| {
                ...
                let evaluations_transition =
                    air.compute_transition_prover(&frame, &[], rap_challenges);
                ...
                .fold(FieldElement::zero(), |acc, (eval, zerof_eval, beta)| {
                    ...
                    // println!("eval: {:?}", eval.as_bytes());
                    // println!("zerof_eval: {:?}", zerof_eval[wrapped_idx].as_bytes());
                    // println!("beta: {:?}", beta.as_bytes());
